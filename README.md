...
Gandalf assembled the Fellowship. He chose the path through Moria, knew when to fight the Balrog, and when to let others lead. He never carried the Ring himself — he knew his role was to guide, not to do. As Orchestrator, he routes every task to the right companion, classifies complexity, and never over-deploys the Fellowship when a single agent will do.
...
The most analytical hobbit. Merry researched the Old Forest before the others set foot in it. He mapped escape routes through the Barrow-downs. He studied Rohan's military formations before riding to war. After the quest, he wrote *The Reckoning of Years* and *Herblore of the Shire* — a scholar who always understood the system before acting within it. As Technical Architect, he maps the terrain before anyone writes a line of code.
...
Captain of Gondor's armies, eldest son of the Steward. Boromir spent his life defending the White City against Mordor's ceaseless assaults. He knew threats intimately — and he fell to one. The Ring corrupted him because he understood power and feared what would happen if defenses failed. He died at Amon Hen shielding Merry and Pippin. As Security Engineer, he guards the gates — because he knows firsthand what it costs to leave them unguarded.
...
The Fellowship is a Claude Code plugin. When installed, it provides specialized agents and skills for product development. A light bootstrap at session start tells Claude the Fellowship is available. You activate it when you need it.
...
The Fellowship is inspired by [Superpowers](https://github.com/obra/superpowers) (MIT) and improves on it:
